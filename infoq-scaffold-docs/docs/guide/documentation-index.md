...
- [`guide/project-overview.md`](/guide/project-overview)：项目定位、工作区分工、能力地图、关键入口。
- [`guide/quick-start.md`](/guide/quick-start)：环境准备、本地启动、最小验证闭环。
- [`guide/faq.md`](/guide/faq)：常见问题和排障入口。
...
- [`collaboration/agents-guide.md`](/collaboration/agents-guide)：`AGENTS.md` 分层说明。
- [`collaboration/skills-guide.md`](/collaboration/skills-guide)：仓库级 skills 目录与使用方式。
- [`collaboration/subagents-guide.md`](/collaboration/subagents-guide)：subagent 角色与职责边界。
- [`collaboration/mcp-servers.md`](/collaboration/mcp-servers)：项目级 MCP server 真值与审批策略。
- [`collaboration/plugin-catalog.md`](/collaboration/plugin-catalog)：插件分类和软开关矩阵。
- [`collaboration/module-doc-governance.md`](/collaboration/module-doc-governance)：模块文档如何分层、聚合、同步与写入 `AGENTS.md` 路由。
