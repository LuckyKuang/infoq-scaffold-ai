  ...
  en_US: {
    translation: {
      ...
      register: {
        ...
        registerSuccess:
          'Congratulations, your {{username}} account has been registered!',
        ...
        rule: {
          ...
          username: {
            required: 'Please enter your account',
            length:
              'The length of the user account must be between {{min}} and {{max}}',
          },
          password: {
            required: 'Please enter your password',
            length:
              'The user password must be between {{min}} and {{max}} in length',
            pattern:
...
export const getLanguage = (): LanguageEnum => {
  return (
    (localStorage.getItem('language') as LanguageEnum) || LanguageEnum.zh_CN
  );
};
