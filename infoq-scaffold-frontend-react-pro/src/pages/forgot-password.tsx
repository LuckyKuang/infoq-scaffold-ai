      ...
      <Form form={form} onFinish={onFinish}>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: t('forgotPassword.rule.email.required'),
            },
        ...
        >
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: t('forgotPassword.rule.emailCode.required'),
              },
            ]}
          >
            <Input
          ...
          >
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: t('forgotPassword.rule.code.required'),
                },
              ]}
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: t('forgotPassword.rule.newPassword.required'),
            },
            {
              min: 8,
              max: 30,
              message: t('forgotPassword.rule.newPassword.length', {
                min: 8,
                max: 30,
              }),
            },
            {
              ...
              message: t('forgotPassword.rule.newPassword.pattern'),
            },
          ]}
        >
          <Input.Password
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: t('forgotPassword.rule.confirmPassword.required'),
            },
            ({ getFieldValue }) => ({
              validator(_, value) {
                ...
                return Promise.reject(
                  new Error(
                    t('forgotPassword.rule.confirmPassword.equalToPassword'),
                  ),
                );
              },
            }),
