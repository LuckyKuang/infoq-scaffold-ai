...
export default function HomePage() {
  ...
  return (
    ...
    >
        ...
        <Col span={24}>
          ...
          >
            <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px' }}>
              ...
              >
                基于编辑感设计规范，致力于提供如精品期刊般的扫读与操作体验。
                系统原生支持动态主题切换，确保在任何环境下都能提供一致且舒适的交互。
              </Paragraph>
        ...
        {features.map((item) => (
          <Col xs={24} md={8} key={item.title}>
            ...
            >
              ...
              <Title
                level={4}
                style={{ marginTop: 0, marginBottom: '16px', color: colorText }}
              >
                {item.title}
              </Title>
              <Paragraph
      ...
      <Divider
        style={{ margin: '40px 0', borderColor: colorBorderSecondary }}
      />
