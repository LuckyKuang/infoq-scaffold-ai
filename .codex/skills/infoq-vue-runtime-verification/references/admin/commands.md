...
node .codex/skills/infoq-vue-runtime-verification/scripts/print_admin_login_inject_snippet.mjs --allow-captcha-disabled
```
...
node .codex/skills/infoq-vue-runtime-verification/scripts/fetch_admin_routes_with_token.mjs --allow-captcha-disabled
```
